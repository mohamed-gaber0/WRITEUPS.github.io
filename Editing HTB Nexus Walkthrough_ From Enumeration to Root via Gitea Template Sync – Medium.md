...
Authenticates to the local Gitea instance ( 127.0.0.1:3000 ) using jones 's credentials.

Requests an API Token via curl .

Creates a new repository named rce with "template": true .

Pushes the malicious code (containing the SSH key) to the repo.
